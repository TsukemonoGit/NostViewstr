...
const test = {
    kind: 1,
    content: 'てすとのもじたち nostr:note1ggwlje0d0lfu92gvvqswacna9uq8zz620n3ls7nk35z5rv34fyusrt73pt',
    tags: [
...
<EventCard tagArray={["e",test.id]} note={test} metadata={undefined} myIndex={0} on:DeleteNote={DeleteNote} on:MoveNote={MoveNote} on:CheckNote={CheckNote} />
<EventCard  tagArray={["e",test.id]} note={test} metadata={metadata} myIndex={1} on:DeleteNote={DeleteNote} on:MoveNote={MoveNote} on:CheckNote={CheckNote}/>
<EventCard  tagArray={["a","30001:84b0c46ab699ac35eb2ca286470b85e081db2087cdef63932236c397417782f5:bookamrk"]} note={test} metadata={metadata} myIndex={1} on:DeleteNote={DeleteNote} on:MoveNote={MoveNote} on:CheckNote={CheckNote}/>